...
```
```bash
sudo hashcat -m 22000 ~/vms/targets/target_handshake/hash.hc22000 rockyou.zip
```
~/vms/targets/target_handshake/hash.hc22000
sudo hashcat -m 22000 ~/VirtualShared/Targets/target_handshake/hash.hc22000 rockyou.zip
